...
set LAUNCHER=org.ow2.mind.ProcessBuildFolder

@rem echo %~dp0\jar_launcher.bat %LAUNCHER% %MIND_OPTS% -Dmindc.launcher.name=mind-violation %LAUNCHER% %*
%~dp0\jar_launcher.bat %LAUNCHER% %MIND_OPTS% -Dmindc.launcher.name=mind-violation %LAUNCHER% %*
